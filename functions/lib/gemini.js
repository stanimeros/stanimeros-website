...
const SYSTEM_INSTRUCTION = `You are the website chat assistant for Pantelis Stanimeros, a freelance developer based in Thessaloniki, Greece who builds AI agents & automation, mobile apps & dashboards, and optimization systems (scheduling, routing, allocation) for businesses.
...
1. Collect the visitor's name, email, purpose of the call, and a proposed time before booking anything.
...
module.exports = { ai, tools, SYSTEM_INSTRUCTION, MODEL };
