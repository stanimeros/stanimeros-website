export default {
  ...
  portfolio: {
    ...
    items: {
      ...
      mpTransfer: {
        title: 'MP-Transfer',
        description: 'Appointment and transfer management for hotels and transport companies.'
      },
      tapfast: {
        title: 'TapFast',
        description: 'QR code platform for badges, carts, coupons, and loyalty programs.'
      },
      mealAi: {
        title: 'Meal AI',
        description: 'AI-powered app that scans food items for nutrition tracking.'
      },
      near: {
        title: 'Near',
        description: 'Privacy-focused social app for location sharing with full data control.'
      },
      reserwave: {
        title: 'Reserwave',
        description: 'Booking and discovery platform with tools for businesses and users.'
      },
      hedeos: {
        title: 'Hedeos',
        description: 'Gamified app for learning Greek with quizzes and progress tracking.'
      },
      ekarotsi: {
        title: 'e-karotsi',
  ...
  getStarted: {
    title: 'Get Started',
    subtitle: "Choose a package and tell me about your needs. I'll reply within 1–2 business days.",
    contactDetails: {
    ...
    serviceSelection: {
      ...
      subtitle: 'Pick the service that best fits your needs',
      onlinePresence: {
        title: 'Online Presence',
    ...
    customApp: {
      ...
      subtitle: 'Describe your app and select the features you need',
